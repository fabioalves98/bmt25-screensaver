...
var images = ['Pedro_santa.png', 'Fabio_santa.png', 'Joaquim_santa.png', 'Ricardo_santa.png', 'Engenheiro_santa.png'];
var is_bmt = true;
...
function changeImage() {
    if (is_bmt) {
        document.getElementById("dvdLogo").src = 'images/' + images[getRandomInt(5)];
        is_bmt = false;
    }
    else {
        document.getElementById("dvdLogo").src = 'images/BMT_santa.png';
        is_bmt = true;
    }
}

// function changeImage() {
//     document.getElementById("dvdLogo").src = all_images[getRandomInt(6)];
// }
